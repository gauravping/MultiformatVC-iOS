                ...
                do {
                    ...
                    do {
                        ...
                        do {
                            ...
                            throw DecodingError.typeMismatch(MixedCodable.self, DecodingError.Context(codingPath: decoder.codingPath, debugDescription: "Encoded payload not of an expected type. Has to be String, Int, Bool, [String], or [String:String]"))
                        }
                    }
                }
            }
